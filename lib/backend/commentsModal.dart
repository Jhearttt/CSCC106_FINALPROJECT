...
class _CommentsCardState extends State<_CommentsCard> {
  ...
  Future<void> _acceptSolution(CommentModel comment) async {
    ...
    if (_hasAccepted) {
      _snack("A solution has already been accepted for this post.", error: true);
      return;
    }
  ...
  void _showAcceptedDialog() {
    AwesomeDialog(
      ...
      desc:       'This help request has been resolved.\n'
      ...
      child: ClipRRect(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          if (_hasAccepted)
            Container(
              ...
              child: const Row(children: [
                ...
                SizedBox(width: 8),
                Expanded(child: Text("This post has an accepted solution.",
                    style: TextStyle(fontSize: 12, color: _kMint,
          ...
          Flexible(child: _loading
            ...
            itemBuilder: (_, i) =>
                _buildCommentThread(_comments[i]),
          ),
          ),
              ...
              Expanded(child: Container(
                ...
                child: TextField(
                  ...
                  style: const TextStyle(
                      color: _kBlueDark, fontSize: 13.5),
                  decoration: InputDecoration(
                      hintText: _replyingTo != null
                          ? 'Write a reply...'
                          : 'Write a comment...',
                      hintStyle: const TextStyle(
                          color: _kBlueLight, fontSize: 13),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: comment.isAccepted
            ? LinearGradient(
            colors: [
              _kMint.withOpacity(0.12),
              _kMint.withOpacity(0.05)
            ],
        ...
        boxShadow: [BoxShadow(
            color: (comment.isAccepted ? _kMint : _kBlue)
                .withOpacity(0.06),
            blurRadius: 6,
      ...
      child: Padding(
        ...
        child: Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildAvatar(comment.userProfilePic, initials,
                  isReply ? 28.0 : 34.0),
              const SizedBox(width: 10),
  ...
  void _confirmAccept(CommentModel comment) {
    AwesomeDialog(
      ...
      desc:       'This will mark "${comment.userFullName ?? "this user"}"\'s '
