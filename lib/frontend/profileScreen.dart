...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> _loadData() async {
    if (widget.localUserId != null) {
      ...
      int _urgencyRank(String u) => u == 'High'
          ? 0
          : u == 'Medium'
          ? 1
          : 2;
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            ...
                            BoxShadow(
                              color: _kBlush.withOpacity(0.14),
                              blurRadius: 12,
  ...
  Widget _reputationStat(String emoji, String value, String label) => Expanded(
    child: Column(
      children: [
  ...
  Widget _brokenImg(double? size) => Container(
    ...
    color: _kVioletSoft,
    child: const Center(
      child: Icon(Icons.broken_image_outlined, color: _kVioletLight),
    ),
  );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    (post['description'] as String? ?? '').length >
                            (hasImage ? 60 : 80)
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
              "Reply to posts to earn skill points",
              ...
              Row(
                ...
                children: [
                  TextButton(
                    ...
                    child: Text(
                      post['status'] == 'Open' ? 'Resolve' : 'Reopen',
                    ),
                  ),
                  TextButton(
