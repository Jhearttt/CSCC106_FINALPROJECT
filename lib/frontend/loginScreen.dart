...
class _BgPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(
      Offset(size.width * 0.10, size.height * 0.12), orb1Radius,
    ...
    canvas.drawCircle(
      Offset(size.width * 0.88, size.height * 0.78), orb2Radius,
      Paint()..shader = RadialGradient(
    ...
    canvas.drawCircle(
      Offset(size.width * 0.92, size.height * 0.35), size.width * 0.22,
      Paint()..shader = RadialGradient(
    ...
    final glowPaint = Paint()
      ..shader = LinearGradient(colors: [
        Colors.transparent, _violetLit.withOpacity(0.18),
        _cyan.withOpacity(0.14), Colors.transparent,
      ]).createShader(Rect.fromLTWH(0, size.height * 0.40, size.width, 1))
      ..strokeWidth = 1.2
      ..style = PaintingStyle.stroke;
    canvas.drawLine(Offset(0, size.height * 0.40),
        Offset(size.width, size.height * 0.40), glowPaint);
...
class _GoogleIconPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawCircle(center, radius - 0.5,
        Paint()..color = _border..style = PaintingStyle.stroke..strokeWidth = 1);
  }
  @override
  bool shouldRepaint(covariant CustomPainter _) => false;
}
...
class _LoginScreenHomeState extends State<LoginScreenHome>
  ...
  void initState() {
    ...
    _logoSlide = Tween<Offset>(begin: const Offset(-0.06, 0), end: Offset.zero)
        .animate(CurvedAnimation(parent: _inCtrl,
  ...
  // ── Authentication: local DB login → redirect to HomePage ────────────────
  Future<void> _validateInputs() async {
    if (usernameController.text.trim().isEmpty) {
      _showError("Username is empty."); return;
    }
    if (passwordController.text.trim().isEmpty) {
      _showError("Password is empty."); return;
    }
    setState(() => _isLoading = true);
    final user = await DatabaseHelper()
        .loginUser(usernameController.text.trim(), passwordController.text.trim());
    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        ...
        builder: (_, __) => Stack(children: [
          CustomPaint(painter: _BgPainter(animValue: _bgCtrl.value),
                  ...
                  child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [BoxShadow(color: _violet.withOpacity(0.45),
                    ...
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ShaderMask(
                        shaderCallback: (b) => _gradVioletCyan.createShader(b),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(children: const [
                          Text("Sign up", style: TextStyle(color: _textMid,
                              fontSize: 12, fontWeight: FontWeight.w600)),
                          SizedBox(width: 4),
                          Icon(Icons.arrow_forward_ios_rounded, color: _textDim, size: 10),
                        ]),
                      ),
                    ),
                  ]),
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(color: _amber.withOpacity(0.35), width: 1),
                        ),
                      ...
                      const Text("Learn.\nConnect.\nThrive.",
                        style: TextStyle(fontSize: 48, fontWeight: FontWeight.w900,
                            color: _textHigh, height: 1.05, letterSpacing: -2.0),
                      ),
                      const SizedBox(height: 14),
                      ClipRRect(
                        borderRadius: BorderRadius.circular(2),
                        child: CustomPaint(painter: _GradLinePainter(),
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Padding(
                      ...
                      child: Column(children: [
                        Row(children: [
                          Expanded(child: Column(
                              ...
                              children: const [
                                Text("Sign in", style: TextStyle(fontSize: 22,
                                    fontWeight: FontWeight.w800, color: _textHigh,
                                    letterSpacing: -0.5)),
                                SizedBox(height: 3),
                                Text("Welcome back 👋",
                          ...
                          Container(width: 40, height: 40,
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [BoxShadow(color: _violet.withOpacity(0.50),
                        ...
                        _buildField(
                          controller: usernameController, focusNode: _userFocus,
                          label: "Username", hint: "Enter your username",
                          icon: Icons.person_outline_rounded,
                        ),
                        const SizedBox(height: 14),
                        _buildField(
                          controller: passwordController, focusNode: _passFocus,
                          label: "Password", hint: "Enter your password",
                          icon: Icons.lock_outline_rounded, obscure: hidePassword,
                          suffix: GestureDetector(
                            onTap: () => setState(() => hidePassword = !hidePassword),
                            child: Padding(
                              padding: const EdgeInsets.only(right: 14),
                              child: Icon(
                                  hidePassword ? Icons.visibility_off_outlined
                        ...
                        Row(children: [
                          ...
                          Padding(padding: const EdgeInsets.symmetric(horizontal: 14),
                              child: Text("or", style: TextStyle(color: _textDim, fontSize: 12))),
                          Expanded(child: Divider(color: _border)),
                        ]),
                        const SizedBox(height: 16),
                            ...
                            child: RichText(text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                  text: "Sign up",
                                  style: TextStyle(
                                    foreground: Paint()..shader = _gradVioletCyan
      ...
      AnimatedContainer(
        ...
        child: Row(children: [
          Padding(padding: const EdgeInsets.only(left: 14),
              child: Icon(icon, color: isFocused ? _violetLit : _textDim, size: 19)),
